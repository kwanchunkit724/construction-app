...
export const DEMO_ACCOUNTS: Array<AuthUser & { password: string }> = [
  ...
  { id: 'ac7f6845-6b01-4a4f-9fa8-b3f48404b080', username: 'pm.chan',      password: 'Admin@2026', name: '陳建文',       role: 'pm',             roleZh: '項目經理',     trade: 'Project Manager',             company: '關春傑工程',      avatar: '陳', projectId: 'PROJ001', permissions: [] },
