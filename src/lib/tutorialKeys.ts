...
// (AppLayout/HelpButton) without pulling the 80KB tutorial dataset into the
// entry chunk. The full content lives in ./tutorials (lazy-loaded).
...
export const TUTORIAL_KEYS: string[] = ["auth-register-login","apply-join-project","multi-tier-approval","project-management","progress-tracking","planned-progress","progress-report-export","report-issue","escalation-chain","handle-resolve-reopen","site-instruction","variation-order","ptw-permit-to-work","daily-log","material-request","timetable","contacts","drawing-version-control","user-role-management","approval-chain-config","dashboard","push-notifications","offline-readonly-cache"]
