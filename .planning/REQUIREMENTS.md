...
- [ ] **INF-06**: Vite `manualChunks` config splits drawing-viewer / pdf / signature / qr libs from main bundle; entry chunk stays <800 KB
- [ ] **INF-07**: Bundle-size CI check fails PR if entry chunk >800 KB or new chunk >400 KB
