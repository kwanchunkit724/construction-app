...
This project is indexed by GitNexus as **construction-app** (15700 symbols, 34750 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
