...
This project is indexed by GitNexus as **construction-app** (12673 symbols, 28390 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
